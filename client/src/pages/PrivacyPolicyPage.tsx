    ...
    <Container sx={{ py: 6, maxWidth: "800px !important" }}>
      ...
      >
        ...
        <Typography>
          ...
          also collect usage data such as your browsing history on our platform,
          IP address, and device information for security purposes (e.g. fraud
        ...
        <Typography>
          ...
          for additional account security. Data is stored on MongoDB Atlas with
          encryption in transit and access restricted by authentication.
        </Typography>

        <Typography sx={{ variant: "h6" }}>4. Third-Party Services</Typography>
        <Typography>
          ...
          hosting), and our email service provider (transactional emails). These
          providers are contractually and technically restricted from using your
          data for any other purpose.
        </Typography>

        <Typography sx={{ variant: "h6" }}>5. Cookies</Typography>
        <Typography>
          We use essential cookies to keep you logged in (authentication tokens)
          and to remember your preferences (such as theme mode). We do not use
        ...
        <Typography>
          ...
          through your profile settings. You may request account deletion by
          contacting support — note that order records may be retained for
        ...
        <Typography>
          Our platform is not intended for individuals under 18 years of age. We
        ...
        <Typography>
          ...
          be communicated via email or a notice on our platform.
        </Typography>

        <Typography sx={{ variant: "h6" }}>10. Contact</Typography>
        <Typography>
          For privacy-related questions or requests, contact us at
          privacy@autopartsbd.example.com.
        </Typography>
      </Box>
    </Container>
  );
