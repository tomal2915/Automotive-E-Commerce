    ...
    <Container sx={{ py: 6, maxWidth: "800px !important" }}>
      ...
      >
        ...
        <Typography>
          ...
          account. We strongly recommend enabling two-factor authentication for
          added security.
        </Typography>
        ...
        <Typography>
          ...
          processed through SSLCommerz, a third-party payment gateway. We do not
          store your card or mobile banking credentials. By placing an order,
          you authorize us to charge the specified amount to your chosen payment
          method.
        </Typography>
        ...
        <Typography>
          ...
          through the original payment method via SSLCommerz's refund system and
          may take several business days to reflect.
        </Typography>
        ...
        <Typography>
          ...
          accounts to abuse promotions or coupons; or submit false, misleading,
          or abusive content (including reviews).
        </Typography>
        ...
        <Typography>
          ...
          support@autopartsbd.example.com.
        </Typography>
      </Box>
    </Container>
  );
